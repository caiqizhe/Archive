...
client_key = 'LA1fSjrsY9yuIxUzOOOLpU6X6' # what Twitter calls Consumer Key
client_secret = 'WlAlL8LRcjE36VETHwFbwlZ8lxHrxdVptegZGZJZehA8F10fQy' # What Twitter calls Consumer Secret
...
# Twitter actually lets you get more than 25 at a time, but not more than 200, so this
...
#                 params = my_params)  # passes {'count': 5, 'max_id': whatever} or just {'count':5} the first time
#     next_five_ids = [tweet['id'] for tweet in r.json()]           
#     ids = ids + next_five_ids
